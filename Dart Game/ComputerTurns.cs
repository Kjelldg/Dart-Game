...
namespace DartSpeletTest4
{
    class ComputerTurns
    {
        ...
        // Den här listan ska hålla reda på varje dators poäng.
        private List<ComputerTurns> totalScore_list = new List<ComputerTurns>();


        // Konstruktor för turns.
        public ComputerTurns(int arrow1 = 0, int arrow2 = 0, int arrow3 = 0)
        {
            _arrow1 = arrow1;
            _arrow2 = arrow2;
            _arrow3 = arrow3;
        ...
        // Den här metoden räknar ihop datorns poäng för alla pilar och returnerar dem.
        ...
        public List<ComputerTurns> _totalScore_list
        {
